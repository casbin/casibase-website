      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "QQ Group",
              href: "https://qm.qq.com/cgi-bin/qm/qr?k=Yt983DUU_-fRcOiOj6SzRUeQJ44Waq2_&jump_from=webapi&authKey=2QUsTg4yotL4cm6z5gQONmxp1mC28pAkr3e/BRlm7FfWrN2na7rc+ye+tu+JXAx+",
            },
            {
              label: "Wechat Group",
      ...
      "@docusaurus/preset-classic",
      {
        ...
        docs: {
          ...
          editUrl: ({locale, docPath}) => {
            ...
            if (locale === "zh") {
              return "https://crowdin.com/project/casibase-website/zh-CN";
            }
            return `https://crowdin.com/project/casibase-website/${locale}`;
          },
        },
        blog: {
