...
Visit: [**http://localhost:13001**](http://localhost:13001) in your browser. Log into Casibase dashboard with the default global admin account: `built-in/admin`
...
Visit: [**http://localhost:14000**](http://localhost:14000) in your browser. Log into Casibase dashboard with the default global admin account: `built-in/admin`
